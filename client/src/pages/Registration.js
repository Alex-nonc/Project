    ...
    <div>
      ...
      <form id="login_form">
        ...
        <label className="login_inputs">
          ...
          <input className="login_input_data" type="email" value={sign_up_email} onChange={e => setEmail(e.target.value)}/>
        </label>
        <label className="login_inputs">
          <p className="reg_email">Пароль:</p>
          <input className="login_input_data" type="password" value={sign_up_passwd} onChange={e => setPasswd(e.target.value)}/>
        </label>
        <label className="login_inputs">
          <p className="reg_email">Телефон:</p>
          <input className="login_input_data" type="text" value={sign_up_phone} onChange={e => setPhone(e.target.value)}/>
        </label>
        <label className="login_inputs">
          <p className="reg_email">Имя:</p>
          <input className="login_input_data" type="text" value={sign_up_name} onChange={e => setName(e.target.value)}/>
        </label>
        <p>
        ...
        <p>
            <button className="login_btn" onClick={sign_in}>Регистрация</button>
        </p>
      </form>
    </div>
  );
